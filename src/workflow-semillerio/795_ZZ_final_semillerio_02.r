...
PARAM$semilla_primos  <- c(100005, 100019, 100037, 100043, 100087,100091,100151,100361,100391,100411,100429,100459,100499,100511,100547,100621,100673,100693)   # se utiliza para generar el vector de  PARAM$semillerio  semillas
